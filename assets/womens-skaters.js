...
(function () {
  ...
  function isHeaderRow(row) {
    ...
    const looksId = (x) => ["helm", "helm id", "helmet", "helmet id", "id"].some((k) => x.includes(k));
    ...
    return looksId(a) && looksName(b) && looksCountry(c);
  }
  ...
  function createMultiSelect(mountEl, { placeholder, onChange }) {
    ...
    btn.type = "button";
    btn.className = "ws-multi-btn";

    const chipline = document.createElement("div");
    chipline.className = "ws-chipline";
    ...
    actions.className = "ws-panel-actions";

    const btnAll = document.createElement("button");
    btnAll.type = "button";
    btnAll.className = "ws-mini";
    btnAll.textContent = "Selecteer alles";

    const btnNone = document.createElement("button");
    btnNone.type = "button";
    btnNone.className = "ws-mini";
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const bodyEl = document.getElementById("wsBody");
    const searchEl = document.getElementById("wsSearch");
    const resetEl = document.getElementById("wsReset");
    ...
    const countrySelect = createMultiSelect(document.getElementById("wsCountryFilter"), {
    ...
    const riderSelect = createMultiSelect(document.getElementById("wsRiderFilter"), {
    ...
    function render() {
      ...
      filtered.forEach((r) => {
        ...
        tdLand.className = "ws-col-country";
